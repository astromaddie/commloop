...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__worker_c

#else
#  define SWIG_init    init_worker_c

#endif
#define SWIG_name    "_worker_c"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_randomarray(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!PyArg_ParseTuple(args,(char *)":randomarray")) SWIG_fail;
  randomarray();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"randomarray", _wrap_randomarray, METH_VARARGS, NULL},
